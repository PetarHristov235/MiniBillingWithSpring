...
public class VatGenerator {
    ...
    public List<Vat> generate(final List<VatPercentages> vatPercentages, final List<InvoiceLine> invoiceLines,
    ...
    private static List<Vat> invoiceLinesVatGenerator(final List<VatPercentages> vatPercentages,

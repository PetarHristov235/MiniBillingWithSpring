...
public class InvoiceGenerator {
     ...
     * end of the line etc.
     */
    public Invoice generate(final User user, final Collection<Measurement> measurements,
                            final LocalDateTime dateReportingTo,
        ...
        final BigDecimal totalAmount = invoiceLines.stream().map(InvoiceLine::getAmount)
                .reduce(taxAmount, BigDecimal::add);
    ...
    private static InvoiceLine  createInvoiceLine(final int lineIndex, final QuantityPricePeriod qpp, final User user,
